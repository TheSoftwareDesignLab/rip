...
public class ExternalProcess {
	...
	public static List<String> executeProcess(List<String> commands, String commandName, String onSuccessMessage,
			String onErrorMessage) throws Exception {
	...
	public static void installAPK(String path) throws Exception {
		...
		List<String> commands = Arrays.asList("adb", "install", path);
		executeProcess(commands, "CHECK APK INSTALLATION", "Installation complete", "App could not be installed");
	}
	...
	public static void startActivity(String activity) throws Exception {
		...
		List<String> commands = Arrays.asList("adb", "shell", "am", "start", "-n", activity);
	 ...
	 *            Y coordinate
	 */
	public static void tap(String coordX, String coordY) throws Exception {
	 ...
	 * @param emulator Name of the emulator to launch
	 * @throws Exception if the emulator does not exist
	 */
	 ...
	 */
	public static void turnOffRotation() throws Exception {
	...
	public static void rotateLandscape() {
		...
		try {
			turnOffRotation();
			List<String> commands = Arrays.asList("adb", "shell", "content", "insert", "--uri",
					"content://settings/system", "--bind", "name:s:user_rotation", "--bind", "value:i:1");
	...
	public static double showMemoryUsage(String packageName) throws Exception {
		...
		if (list.length != 0) {
			String temp = list[0].toLowerCase().split(":")[0].replaceAll("k", "").replaceAll("b", "").replaceAll("\\s+", "").replaceAll(",", "");
	 ...
	 */
	public static String getAndroidVersion() throws Exception {
		List<String> commands = Arrays.asList("adb", "shell", "getprop", "ro.build.version.release");
		List<String> answer = executeProcess(commands, "CHEKING ANDROID VERSION", null, null);
	 ...
	 */
	public static String getCurrentFocus() throws Exception {
	 ...
	 *             if there is no device
	 */
	public static String getFocusedApp() throws Exception {
	 ...
	 *             if there is no device
	 */
	public static String getScreenDimensions() throws Exception {
		List<String> commands = Arrays.asList("adb", "shell", "wm", "size");
		List<String> answer = executeProcess(commands, "CHEKING DEVICE DIMENSIONS", null, null);
	 ...
	 */
	public static boolean isHome() throws Exception {
		boolean ans = false;
	 ...
	 */
	public static boolean isKeyboardOpen() throws Exception {
	 ...
	 * @throws Exception
	 */
	public static int checkInputType() throws Exception {
		int ret = 0;
	 ...
	 *             if any path is bad
	 */
	public static String getPackageName(String aapt, String apk) throws Exception {
	 ...
	 *             if any path is bad
	 */
	public static String getMainActivity(String aapt, String apk) throws Exception {
		...
		if(!a.equals("")) {
			...
			throw new Exception("There is no launchable activity");
		}
		return b;
	 ...
	 */
	public static String getSensors() throws Exception {
	 ...
	 *             if there is no device connected
	 */
	public static String getServices(String packageName) throws Exception {
	...
	public static String turnWifi(boolean value) throws Exception {
		String sw = "OFF";
	...
	public static String turnBluetooth(boolean value) throws Exception {
		String sw = "OFF";
	...
	public static String turnMobileData(boolean value) throws Exception {
		String sw = "OFF";
	...
	public static String turnInternet(boolean value) throws Exception {
		return turnWifi(value) + "\n" +turnMobileData(value);
	}
	
	public static String turnLocationServices(boolean value) throws Exception {
		return turnGPS(value) + "\n" +turnNetworkLocation(value);
	}
	
	public static String turnGPS(boolean value) throws Exception {
		String sw = "OFF";
		...
		List<String> commands = Arrays.asList("adb", "shell", "settings", "put", "secure", "location_providers_allowed", dataValue);
	...
	public static String turnNetworkLocation(boolean value) throws Exception {
	String sw = "OFF";
